...
Dado que eu acesse o php travels
    ...
    Click Element    ${Home.a_Costumer}

E realize o cadastro
    Wait Until Element Is Enabled      ${Home.A_Signup}            20
    Click Element                      ${Home.A_Signup}
    Wait Until Element Is Visible      ${Login.Input_PrimeiroNome}  25
    ...
    Wait Until Element Is Visible      ${Login.Input_Telefone}      15
    ...
    Wait Until Element Is Visible      ${Login.Button_Cookie}       15
