...
E realize o cadastro
    Wait Until Element Is Enabled      ${home.A_Signup}            25
    Click Element                      ${home.A_Signup}
    Wait Until Element Is Visible      ${registro.Input_PrimeiroNome}  25
    ...
    Wait Until Element Is Visible      ${registro.Input_Telefone}      15
    ...
    Wait Until Element Is Visible      ${registro.Button_Cookie}       15
    Click Element                      ${registro.Button_Cookie}          
    Wait Until Element Is Visible      ${registro.Button_Signup}       10 
    Sleep                              2s
    Run Keyword And Ignore Error       Click Element                      ${registro.Login.Button_Signup}    
